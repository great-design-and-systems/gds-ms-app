...
export default class Field extends React.Component {
    ...
    render() {
        return (
            <li class="tabs-title"><a class="column large-9 medium-9 small-9 field">{this.props.field.value}</a><a onClick={this.removeFileField.bind(this)} class="column large-3 medium-3 small-3">remove</a></li>
        );
    }
}